...
export default function Footer() {
  return (
    <footer className="h-fit pb-20 lg:pb-0 lg:pt-0 bg-[#EAEAEA] pt-12 border-t border-[#8F8F8F]">
      <div className='flex flex-col lg:flex-row justify-center items-center lg:max-w-fit mx-auto lg:space-x-12'>

        <div className="flex flex-col mx-5 lg:mx-0 lg:max-w-[250px] justify-center items-center lg:items-start">
          <h3 className="text-3xl">Ceramic</h3>
          <span className="font-archivo w-[90%] mt-4 lg:text-xs lg:w-[90%] text-[#535353]">
            Ceramics Club strives to provide a space for creative individuals.
          </span>
        </div>

        <div className='mx-0 flex flex-col lg:flex-row justify-center items-center space-y-8 mt-10 lg:mt-0 lg:gap-10'>
        ...
        <div className='mx-5 lg:hidden xl:flex mt-20 lg:mt-0 flex flex-col justify-center items-center lg:ml-24'>
