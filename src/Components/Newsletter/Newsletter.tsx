...
export default function Newsletter() {
  return (
    <section className="w-full flex flex-col justify-center mx-auto">
      <div className="lg:flex bg-img h-screen lg:h-[60vh] lg:flex-row mx-auto items-center justify-center">
        <div className="mt-2 mx-5 flex flex-col">
          ...
          <div className="flex flex-col w-[90%] mx-auto mt-12 space-y-3 lg:space-y-0 lg:flex-row lg:space-x-4">
            <input className="border px-3 py-2 focus:outline-none lg:h-[5vh] rounded-lg w-full mx-auto" type="text" placeholder="Enter your email" name="" id="" />
