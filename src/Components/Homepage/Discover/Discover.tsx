...
export default function Discover() {
  return (
    <div className="w-full h-fit my-20 relative lg:w-full mx-auto xl:max-w-[1400px]">
      <div className="mx-5 lg:mx-0">
        ...
        <div className="lg:h-fit flex justify-end">
          <img
            className="mt-20 lg:mt-60 lg:rounded-sm md:h-[52vh] lg:h-[70vh] lg:w-[700px] object-cover rounded-xl w-full"
            src={Image}
            alt=""
          />
        </div>
